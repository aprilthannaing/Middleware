...
public class WipoEndPonintsController extends AbstractController {
    ...
    /*
     * request ------- { "transaction": { â€œtransactionIdâ€�:â€�
     * 00906988547578Bâ€�, // Generated by payment gateway
     * "bankIdentifier":" ACLEDA", "currencyType":"KHR", "amount":"250",
     * "amountDetails": [ { "amount": 150.00, "description": "1*150.00", "feeCode":
     * "1001" }, { "amount": 100.00, "description": "2*50.00", " feeCode ": "1002" }
     * ],
     * 
